Userstyles::Application.configure do
  ...
  config.action_controller.asset_host = "https://df6a.https.cdn.softlayer.net/80DF6A/static.userstyles.org"
...
STATIC_DOMAIN = 'https://df6a.https.cdn.softlayer.net/80DF6A/static.userstyles.org'
