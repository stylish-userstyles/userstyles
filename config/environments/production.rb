Userstyles::Application.configure do
  ...
  config.action_controller.asset_host = "http://df6a.http.cdn.softlayer.net/80DF6A/static.userstyles.org"
...
STATIC_DOMAIN = 'http://df6a.http.cdn.softlayer.net/80DF6A/static.userstyles.org'
UPDATE_DOMAIN = 'https://update.userstyles.org'
SCREENSHOT_DOMAIN = 'http://df6a.http.cdn.softlayer.net/80DF6A/static.userstyles.org'
